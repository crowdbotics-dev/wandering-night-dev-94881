...
## Project Structure
    ...
    ├── wandering_night_dev_94881  # Django project configurations
...
1. Clone this repo and `cd wandering_night_dev_94881`
...
2. Clone this repo and `cd wandering_night_dev_94881`
